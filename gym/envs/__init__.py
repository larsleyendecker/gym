...
register(
    id='Ur10Heg-v2',
    entry_point='gym.envs.robotics:Ur10HegSparseEnv',
    max_episode_steps=4000,
)
...
register(
    id = 'UR10HEG-v000',
    entry_point = 'gym.envs.robotics:Ur10HegStaticEnv',
    max_episode_steps = 500,
)
...
register(
    id="UR10HEG-v002",
    entry_point = 'gym.envs.robotics:Ur10HegGenesisEnv',
    max_episode_steps = 500,
)
register(
    id="UR10HEG-v003",
    entry_point = "gym.envs.robotics:Ur10HegNoisyPositionEnv",
    max_episode_steps = 500,
)
register(
    id="UR10HEG-v004",
