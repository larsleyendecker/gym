...
class Ur10Env(robot_custom_env.RobotEnv):
    ...
    def _get_obs(self):
        ...
        pos_dr_uncor_noise = numpy.random.uniform(-self.pos_var_dr_uncor, self.pos_var_dr_uncor,3)
        ...
        rot_si_noise = numpy.random.normal(0.0, self.rot_std_si, 3) * (numpy.pi/180)
        rot_dr_uncor_noise = numpy.random.uniform(-self.rot_var_dr_uncor, self.rot_var_dr_uncor, 3)*(numpy.pi/180)
    ...
    def _reset_sim(self):
        ...
        self.pos_dr_cor_noise = numpy.uniform(-self.pos_var_dr_cor, self.pos_var_dr_cor,3)
        self.rot_dr_cor_noise = numpy.uniform(-self.rot_var_dr_cor, self.rot_var_dr_cor, 3) *(numpy.pi/180)
